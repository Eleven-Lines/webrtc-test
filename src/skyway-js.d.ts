...
declare class Peer {
    ...
    public call(peerId: string, stream?: MediaStream, options?: CallOptions): MediaConnection | undefined;
    public connect(peerId: string, options?: ConnectOptions): DataConnection | undefined;
    public destroy(): undefined;
    public disconnect(): undefined;
    public joinRoom(roomName: string, roomOptions?: RoomOptions): SFURoom | MeshRoom | undefined | null;
...
declare class MediaConnection {
    ...
    public on(event: 'close', cb: () => void): void;
    public on(event: 'removeStream', cb: (reamoteStream: MediaStream) => void): void;
}
